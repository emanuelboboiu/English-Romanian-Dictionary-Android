...
public class StringTools {
    ...
    public StringTools(Context context) {
        ...
        if (ims != null) {
            ...
            // GUITools.alert(context, "Old", locale);
        }

        if (locale.startsWith("ro")) {
            // GUITools.alert(context, "Romanian!", "");
    ...
    public String replaceCharacters(String str) {
        ...
        switch (keyboardLanguage) {
            ...
            default:
                /*
                 * Romanian language which is case 1 in fact. It be possible to make
                 * copy paste for romanian words and the keyboard to be another
                 * locale, we need to replace anyway the diacritics.
                 */
